...
from FeedbackProcessing import createSideBySide
...
def processUserVideo(userFile):
    ...
    outputFilePath = 'webapp-backend/userAnnotatedVideo.mp4'
    out = cv2.VideoWriter(outputFilePath, cv2.VideoWriter_fourcc(*"mp4v"), fps, (width, height))
    ...
    print("user video annotated")
    print(outputFilePath)
    #convert to side by side
    return createSideBySide(outputFilePath)
